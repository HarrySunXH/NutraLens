    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50/20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl border border-gray-100 shadow-sm p-1.5 mb-8 grid grid-cols-3 sm:flex gap-1"
        >
          {TABS.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={`relative flex-1 flex items-center justify-center gap-1.5 px-2 py-2.5 rounded-xl text-xs sm:text-sm font-medium transition-all duration-200 ${
                  isActive
              ...
              >
                ...
                <span className="relative z-10 truncate">{tab.label.split(" ")[0]}</span>
              </button>
            );
          })}
        </motion.div>
